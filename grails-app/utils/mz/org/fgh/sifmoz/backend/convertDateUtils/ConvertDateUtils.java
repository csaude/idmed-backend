...
public class ConvertDateUtils {
    ...
    /**
     * Subtract uma um perido de tempo (em dias) a uma data passada pelo parametro
     * @param dataInicial
     * @param qtdDias
     * @return Retorna a dataInicial subtraida ao tempo passado pelo parametro qtdDias
     */
    public static Date subtractDaysDate(Date dataInicial, int qtdDias){
        Calendar calendar = Calendar.getInstance();
